...
curl -s "$BASE/workspaces/$WS/ir3/map" | python3 -c 'import sys,json; d=json.load(sys.stdin); assert "map" in d and d["map"]["summary"]["donationReceiptAmount"] == 175 and d["map"]["summary"]["donationAmount"] == 175'
